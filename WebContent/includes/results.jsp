		...
		<div class="span3">
			<div class="well sidebar-nav">
				<ul class="nav nav-list">
					...
					<li><a href="#scenario1" data-toggle="tab">1.
							max(electric)</a></li>
				...
				<div class="span10">
					<p class="muted text-right">
						<small>The service has been queried <strong
							class="text-info"><span id="statComputations"><% out.print(Wrapper.getInstance().getComputations()); %></span>
								time(s)</strong> during this working session.<br /> The computations of
							the above scenarios took <strong class="text-info"><span
								id="statTimestamp"><% out.print(Wrapper.getInstance().getTimestamp()); %></span></strong>.
						</small>
					</p>
				</div>
