 ...
 * 
 */
public class Thermals extends AbstractGraph implements Graph {
	 ...
	 */
	public Thermals(Objective[] objectives, GlobalOptOutput[] results) {
	...
	protected void compute() {
		...
		for (PrimaryActivity activity : activities)
			if (activity.getActivityType().equals(ActivityType.THERMAL))
